...
static inline void
line_insert(e_Line *lp, e_Line *lp_new)
{
	e_Line *tmp = lp->l_bp;
...
static inline void
line_replace(e_Line *lp, e_Line *lp_new)
{
	lp->l_bp->l_fp = lp_new;
	lp->l_fp->l_bp = lp_new;
	lp_new->l_fp = lp->l_fp;
...
static inline void
wstate_restore(e_Window *wp, e_Buffer *bp)
{
	wp->w_dotp = bp->b_dotp;
	wp->w_doto = bp->b_doto;
...
static inline void
wstate_copy(e_Window *wp, e_Window *wp2)
{
